...
const privacyPolicy = () => {
  return [
    ...
    },
    {
      ...
      desc: (
        <p>
          Burning Zombies follows a standard procedure of using log files. These
    ...
    },
    {
      ...
      desc: (
        <p>
          Like any other website, Burning Zombies uses &apos;cookies&apos;.
      ...
      desc: (
        <>
          <p>
            ...
            advertising partners of Burning Zombies.
          </p>

          <p>
            Third-party ad servers or ad networks uses technologies like
            cookies, JavaScript, or Web Beacons that are used in their
            respective advertisements and links that appear on Burning Zombies,
          ...
          <p>
            Note that Burning Zombies has no access to or control over these
    ...
    },
    {
      ...
      desc: (
        <>
          <p>
            Burning Zombies&apos;s Privacy Policy does not apply to other
    ...
    },
    {
      ...
      desc: (
        <>
          ...
          <p>
            Burning Zombies does not knowingly collect any Personal Identifiable
    ...
    <Layout>
      ...
      <div className="container py-5">
        ...
        <div className="text-light text-shadow">
          <p>
            At Burning Zombies, accessible from https://burningzombies.com, one
            of our main priorities is the privacy of our visitors. This Privacy
            Policy document contains types of information that is collected and
            recorded by Burning Zombies and how we use it.
          </p>
          ...
          <p>
            ...
            that they shared and/or collect in Burning Zombies. This policy is
            not applicable to any information collected offline or via channels
            other than this website.{" "}
          </p>
        </div>

        {privacyPolicy().map((x, i) => (
          <div className="mb-3" key={i}>
            <h3 className="mb-2 mt-5 text-light text-shadow fw-bold h4">
              {x.title}
            </h3>
            {x.desc}
          </div>
